    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                {!! Form::open(['action' => 'EmployeeDetailsController@store', 'method'=>'POST']) !!}
                        ...
                        <div class="form-group row">
                            ...
                            {{Form::number('salary','',['class'=>'form-control','placeholder'=>'Salary'])}}
                                                                               
                        </div>

                        <div class="form-group row">
                            {{Form::label('joining_date','Joining Date')}}
                            {{Form::date('joining_date','',['class'=>'form-control'])}}
